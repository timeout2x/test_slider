define(['angular'], function (angular) {
  ...
  angular.module('app', [])
    .controller('WeatherListController', ['$scope', '$http', function($scope, $http) {
      var url = 'http://query.yahooapis.com/v1/public/yql?q=use%20\'http%3A%2F%2Fgithub.com%2Fyql%2Fyql-tables%2Fraw%2Fmaster%2Fweather%2Fweather.bylocation.xml\'%20as%20we%3Bselect%20*%20from%20we%20where%20unit%3D\'c\'%20and%20location%20in(\'moscow\'%2C%20\'opatija\'%2C%20\'london\'%2C%20\'washington\'%2C%20\'paris\')&format=json&env=store%3A%2F%2Fdatatables.org%2Falltableswithkeys&callback=JSON_CALLBACK'
      , interval, timeout;

      $http.jsonp(url).success(function(data) {
        if (data && data.error) {
          alert('Yahoo returned following error: '+data.error);
          return;
        }
